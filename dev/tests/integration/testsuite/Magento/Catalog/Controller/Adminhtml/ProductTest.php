...
class ProductTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testIndexAction()
    {
        ...
        $this->assertEquals(
            ...
            '"Add Product" button container should be present on Manage Orders page, if the limit is not  reached'
        );
        $this->assertEquals(
            1,
            \Magento\TestFramework\Helper\Xpath::getElementsCountForXpath(
            ...
            '"Add Product" button should be present on Manage Orders page, if the limit is not reached'
        );
        $this->assertEquals(
            0,
            \Magento\TestFramework\Helper\Xpath::getElementsCountForXpath(
            ...
            '"Add Product" button should be enabled on Manage Orders page, if the limit is not reached'
        );
        $this->assertEquals(
            1,
            \Magento\TestFramework\Helper\Xpath::getElementsCountForXpath(
            ...
            '"Add Product" button split should be present on Manage Orders page, if the limit is not reached'
        );
    }
