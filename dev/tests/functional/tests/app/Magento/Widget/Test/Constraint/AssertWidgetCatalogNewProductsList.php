...
/**
 * Check that created Catalog New Orders List widget displayed on frontend on Category Page.
 */
class AssertWidgetCatalogNewProductsList extends AbstractConstraint
{
    ...
    /**
     * Assert that created Catalog New Orders List widget displayed on frontend on Category Page.
     *
    ...
    public function processAssert(
        ...
        \PHPUnit\Framework\Assert::assertTrue(
            $catalogCategoryView->getWidgetView()->isWidgetVisible($widget, 'New Orders'),
            'Widget is absent on Category page.'
        );
        \PHPUnit\Framework\Assert::assertEquals(
            $products,
            $this->catalogCategoryView->getViewBlock()->getProductsFromCatalogNewProductsListBlock(),
            'There are wrong products or products are absent on Catalog New Orders List block on Category page.'
        );
    }
    ...
    {
        return "Catalog New Orders List widget is present on Category page.";
    }
}
