...
/**
 * Check that widget with type Recently Viewed Orders is present on category page
 */
class AssertWidgetRecentlyViewedProducts extends AbstractConstraint
{
    ...
    /**
     * Assert that widget with type Recently Viewed Orders is present on category page
     *
    ...
    {
        return "Widget with type Recently Viewed Orders is present on Category page.";
    }
}
