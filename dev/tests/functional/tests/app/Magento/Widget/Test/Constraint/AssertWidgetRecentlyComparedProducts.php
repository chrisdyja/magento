...
/**
 * Check that widget with type Recently Compared Orders is present on Product Compare page
 */
class AssertWidgetRecentlyComparedProducts extends AbstractConstraint
{
    ...
    /**
     * Assert that widget with type Recently Compared Orders is present on Product Compare page
     *
    ...
    protected function removeCompareProducts()
    {
        ...
        $this->cmsIndex->getLinksBlock()->openLink("Compare Orders");
    ...
    {
        return "Widget with type Recently Compared Orders is present on Product Compare page";
    }
}
