 ...
 * Assert that product is present in Orders in Carts report grid
 */
class AssertProductInCartResult extends AbstractConstraint
{
    /**
     * Assert that product is present in Orders in Carts report grid by name, price, carts
     *
    ...
    public function processAssert(ShopCartProductReport $shopCartProductReport, CatalogProductSimple $product, $carts)
    {
        ...
        \PHPUnit\Framework\Assert::assertTrue(
            ...
            'Product is absent in Orders in Carts report grid.'
        );
    }
    ...
    {
        return 'Product is present in Orders in Carts report grid with correct carts number.';
    }
}
