...
class Page extends Block
{
    ...
    protected $widgetSelectors = [
        ...
        'Recently Compared Orders' => './/*/div[contains(@class,"block widget compared grid") and contains(.,"%s")]',
        'Recently Viewed Orders' => './/*/div[contains(@class,"block widget viewed grid") and contains(.,"%s")]',
        'Catalog New Orders List' => './/*/div[contains(@class,"widget new") and contains(.,"%s")]',
