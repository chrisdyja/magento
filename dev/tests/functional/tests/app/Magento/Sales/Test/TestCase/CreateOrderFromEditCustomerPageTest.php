 ...
 * 5. Select Store.
 * 6. Click Add Orders button.
 * 7. Select corresponded Orders.
 * 8. Click Add Selected Product(s) to Order button.
 * 9. Perform assertions.
 * 10. Select Move to Wish List action for Orders from Test Data.
 * 11. Click Update Items and Quantities button.
 * 12. Perform assertions.
 * 13. Select Add to Order in "Wish List" data grid for correspondent Orders.
 * 14. Click Update Changes button.
 * 15. Perform assertions.
 * 16. Select Move to Shopping Cart action for Orders from Test Data.
 * 17. Click Update Items and Quantities button.
 * 18. Perform assertions.
 * 19. Select Add to Order in "Shopping Cart" data grid for correspondent Orders.
