 ...
 * Assert message on "Compare Orders" page after removing product
 */
class AssertProductCompareRemoveLastProductMessage extends AbstractConstraint
{
    ...
    /**
     * After removing last product message is appeared on "Compare Orders" page
     *
    ...
    {
        return 'After removing last product the message appears on "Compare Orders" page.';
    }
}
