 ...
 * Assert the product is not displayed on Compare Orders block on my account page
 */
class AssertProductIsNotVisibleInCompareBlock extends AbstractConstraint
{
    ...
    public function processAssert(
        ...
        if (($countProducts > 1) && ($product !== null)) {
            \PHPUnit\Framework\Assert::assertFalse(
                ...
                'The product displays on Compare Orders block on my account page.'
            );
        } else {
    ...
    {
        return 'The message appears on Compare Orders block on my account page.';
    }
}
