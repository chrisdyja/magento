 ...
 * Assert the product is not displayed on Compare Orders page
 */
class AssertProductIsNotVisibleInComparePage extends AbstractConstraint
{
    ...
    public function processAssert(CatalogProductCompare $comparePage, FixtureInterface $product, $countProducts = 0)
    {
        ...
        if ($countProducts > 1) {
            \PHPUnit\Framework\Assert::assertFalse(
                ...
                'The product displays on Compare Orders page.'
            );
        } else {
    ...
    {
        return 'Orders is not displayed on Compare Orders page.';
    }
}
