<?php
namespace TrelloCLI\Orders\Console\CancelWeekOldOrders;

/**
 * Interceptor class for @see \TrelloCLI\Orders\Console\CancelWeekOldOrders
 */
class Interceptor extends \TrelloCLI\Orders\Console\CancelWeekOldOrders implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\TrelloCLI\Orders\Model\CancelOrder $cancelOrder, \TrelloCLI\Orders\Model\Order $order, ?string $name = null)
    {
        $this->___init();
        parent::__construct($cancelOrder, $order, $name);
    }
